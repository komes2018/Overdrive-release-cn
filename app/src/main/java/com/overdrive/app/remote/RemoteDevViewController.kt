...
object RemoteDevViewController : Application.ActivityLifecycleCallbacks {
    ...
    fun isAccessAllowed(): Boolean = try {
    ...
    private fun lockedCaptureResult() = CaptureResult(
        resultCode = -1,
        resultName = "LOCKED",
        width = 0,
        height = 0,
